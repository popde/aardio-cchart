...
enum
{
	...
	kTypeSplit = kTypeSingleLayerCount,	//9 分裂视图
	kTypeShareX,						//10 共享X轴视图
	kTypeLayered,						//11 分层视图
	
	kType2DCount,						// 二维视图数目

	kType3DLine = kType2DCount,			//12 3维折线图
	kType3DSurface,						//13 3维曲面图
...
{
	{kTypeXY			,_T("TypeXY")			,_T("xy")},
	{kTypePie			,_T("TypePie")			,_T("pie")},
	{kTypeStem			,_T("TypeStem")			,_T("stem")},
	{kTypeOscillo		,_T("TypeOscillo")		,_T("oscillo")},
	{kTypeContourLine	,_T("TypeContourLine")	,_T("contourline")},
	{kTypeContourMap	,_T("TypeContourMap")	,_T("contourmap")},
	{kTypeContour		,_T("TypeContour")		,_T("contour")},
	{kTypeHeatMap		,_T("TypeHeatMap")		,_T("heatmap")},
	{kTypeXY3D			,_T("TypeXY3D")			,_T("xy3d")},
	{kTypeSplit			,_T("TypeSplit")		,_T("split")},
	{kTypeShareX		,_T("TypeShareX")		,_T("sharex")},
	{kTypeLayered		,_T("TypeLayered")		,_T("layered")},
	{kType3DLine		,_T("Type3DLine")		,_T("3dline")},
...
public:
	// 对预置窗口句柄绘图，预置窗口可以用SetWnd()设置，也可调用其它OnDraw自动设置
	virtual	void		OnDraw();
	// 对窗口句柄绘图
...
///////////////////////////////////////////////////////////////////////////////////////////
// 判断指针是否有效，主要是检查内部资源是否已经被释放
// 在多线程时候使用，因为有可能一个线程已经释放资源，另一个线程还在按常规操作
